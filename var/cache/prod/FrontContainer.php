...
class FrontContainer extends \PrestaShop\PrestaShop\Adapter\Container\LegacyContainer
{
    ...
    {
        return $container->services['PrestaShop\\ModuleLibCacheDirectoryProvider\\Cache\\CacheDirectoryProvider'] = new \PrestaShop\ModuleLibCacheDirectoryProvider\Cache\CacheDirectoryProvider('9.0.2', 'C:\\wamp64\\www\\prestashop9', false);
    }
    ...
    {
        return $container->services['PsCheckout\\Cache\\FileSystem\\PayPalOrder'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('paypal-orders', 3600, ($container->services['PrestaShop\\ModuleLibCacheDirectoryProvider\\Cache\\CacheDirectoryProvider'] ??= new \PrestaShop\ModuleLibCacheDirectoryProvider\Cache\CacheDirectoryProvider('9.0.2', 'C:\\wamp64\\www\\prestashop9', false))->getPath());
    }
    ...
    {
        return $container->services['PsCheckout\\Cache\\FileSystem\\ShippingTracking'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('shipping-tracking', 3600, ($container->services['PrestaShop\\ModuleLibCacheDirectoryProvider\\Cache\\CacheDirectoryProvider'] ??= new \PrestaShop\ModuleLibCacheDirectoryProvider\Cache\CacheDirectoryProvider('9.0.2', 'C:\\wamp64\\www\\prestashop9', false))->getPath());
    }
    ...
    {
        return $container->services['prestashop.adapter.employee_language_updater'] = new \PrestaShop\PrestaShop\Adapter\Employee\EmployeeLanguageUpdater(($container->services['doctrine.dbal.default_connection'] ?? self::getDoctrine_Dbal_DefaultConnectionService($container)), 'ps_detente_', ($container->services['PrestaShop\\PrestaShop\\Adapter\\Configuration'] ??= new \PrestaShop\PrestaShop\Adapter\Configuration())->get("PS_LANG_DEFAULT"));
    }
    ...
    {
        return $container->services['prestashop.adapter.module.repository.module_repository'] = new \PrestaShop\PrestaShop\Adapter\Module\Repository\ModuleRepository('C:\\wamp64\\www\\prestashop9', 'C:\\wamp64\\www\\prestashop9/modules/');
    }
    ...
    {
        return $container->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, 'C:\\wamp64\\www\\prestashop9/var/cache/prod\\/localization');
    }
    ...
    {
        return $container->services['prestashop.database.naming_strategy'] = new \PrestaShopBundle\Service\Database\DoctrineNamingStrategy(($container->services['annotation_reader'] ??= new \Doctrine\Common\Annotations\AnnotationReader()), 'ps_detente_');
    }
    ...
    {
        return $container->services['prestashop.translation.translator_language_loader'] = new \PrestaShopBundle\Translation\TranslatorLanguageLoader(($container->services['prestashop.adapter.module.repository.module_repository'] ??= new \PrestaShop\PrestaShop\Adapter\Module\Repository\ModuleRepository('C:\\wamp64\\www\\prestashop9', 'C:\\wamp64\\www\\prestashop9/modules/')));
    }
    ...
    {
        return $container->services['product_comment_criterion_repository'] = new \PrestaShop\Module\ProductComment\Repository\ProductCommentCriterionRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)), ($container->services['doctrine.dbal.default_connection'] ?? self::getDoctrine_Dbal_DefaultConnectionService($container)), 'ps_detente_');
    }
    ...
    {
        return $container->services['product_comment_repository'] = new \PrestaShop\Module\ProductComment\Repository\ProductCommentRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)), ($container->services['doctrine.dbal.default_connection'] ?? self::getDoctrine_Dbal_DefaultConnectionService($container)), 'ps_detente_', ($container->services['PrestaShop\\PrestaShop\\Adapter\\Configuration'] ??= new \PrestaShop\PrestaShop\Adapter\Configuration())->get("PRODUCT_COMMENTS_ALLOW_GUESTS"), ($container->services['PrestaShop\\PrestaShop\\Adapter\\Configuration'] ??= new \PrestaShop\PrestaShop\Adapter\Configuration())->get("PRODUCT_COMMENTS_MINIMAL_TIME"));
    }
    ...
    protected static function getDotEnvLayerService($container, $lazyLoad = true)
    {
        ...
        return ($lazyLoad->__construct(($container->services['prestashop.adapter.environment'] ??= new \PrestaShop\PrestaShop\Adapter\Environment(false, 'prod', 'front')), 'C:\\wamp64\\www\\prestashop9') && false ?: $lazyLoad);
    }
    ...
    protected static function getDoctrine_Orm_DefaultConfigurationService($container)
    {
        ...
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, ['C:\\wamp64\\www\\prestashop9\\src\\PrestaShopBundle\\Entity']), 'PrestaShop');
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, ['C:\\wamp64\\www\\prestashop9\\modules\\productcomments\\src\\Entity']), 'PrestaShop\\Module\\ProductComment\\Entity');
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, ['C:\\wamp64\\www\\prestashop9\\modules\\psshipping\\src\\Entity']), 'PrestaShop\\Module\\Psshipping\\Entity');
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, ['C:\\wamp64\\www\\prestashop9\\modules\\ps_accounts\\src\\Entity']), 'PrestaShop\\Module\\PsAccounts\\Entity');
        ...
        $instance->setProxyDir('C:\\wamp64\\www\\prestashop9/var/cache/prod\\/doctrine/orm/Proxies');
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.app_id' => 'front',
            'kernel.cache_dir' => 'C:\\wamp64\\www\\prestashop9/var/cache/prod\\',
            ...
            'prestashop.module_dir' => 'C:\\wamp64\\www\\prestashop9/modules/',
            'kernel.project_dir' => 'C:\\wamp64\\www\\prestashop9',
            'ps_cache_dir' => 'C:\\wamp64\\www\\prestashop9/var/cache/prod\\',
            ...
            'doctrine.orm.proxy_dir' => 'C:\\wamp64\\www\\prestashop9/var/cache/prod\\/doctrine/orm/Proxies',
