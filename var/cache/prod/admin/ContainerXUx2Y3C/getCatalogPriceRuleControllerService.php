...
class getCatalogPriceRuleControllerService extends AdminKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.3apI8Sp'] ?? $container->load('get_ServiceLocator_3apI8SpService'))->withContext('PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\CatalogPriceRuleController', $container));
