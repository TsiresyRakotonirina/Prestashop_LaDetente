...
$catalogue = new MessageCatalogue('fr-FR', array (
  ...
  array (
    'Refund has been processed by PayPal.' => 'Le remboursement a été effectué par PayPal.',
    'Refund cannot be processed by PayPal.' => 'Le remboursement n\'a pas pu être effectué par PayPal.',
    'Refund has been processed by PayPal, but order status change or email sending failed.' => 'Le remboursement a été traité par PayPal, mais le changement de statut de la commande ou l\'envoi de l\'e-mail a échoué.',
    'PayPal refund failed.' => 'PayPal refund failed.',
    'PayPal refund amount is invalid.' => 'Montant de remboursement PayPal invalide.',
    'PayPal refund currency is invalid.' => 'Devise de remboursement PayPal invalide.',
    'PayPal Transaction is invalid.' => 'Transaction PayPal invalide.',
    'PayPal Order is invalid.' => 'Commande PayPal invalide.',
    'PayPal Order %s is not in the same environment as PrestaShop Checkout' => 'PayPal Order %s is not in the same environment as PrestaShop Checkout',
    'Unable to find PayPal Order associated to this PrestaShop Order %s' => 'Unable to find PayPal Order associated to this PrestaShop Order %s',
    'No PrestaShop Order identifier received' => 'Aucune référence de commande PrestaShop reçue',
    'Provide the most commonly used payment methods to your customers in this all-in-one module, and manage all your sales in a centralized interface.' => 'Fournissez les moyens de paiement les plus couramment utilisés à vos clients dans ce module tout-en-un, et gérez toutes vos ventes dans une interface centralisée.',
    'PrestaShop Checkout' => 'PrestaShop Checkout',
    'The payer did not authorize the payment.' => 'Le payeur n\'a pas autorisé le paiement.',
    'The payer paid for an item that they did not receive.' => 'Le payeur a payé un article qu\'il n\'a pas reçu.',
    'For more information, please go to the official PayPal website.' => 'Pour plus d\'informations, veuillez vous rendre sur le site officiel de PayPal.',
    'Dispute categories covered:' => 'Catégories de litiges couvertes :',
    'Your PayPal balance is not protected, the transaction is not eligible to the seller protection program.' => 'Votre solde PayPal n\'est pas protégé, la transaction n\'est pas éligible au programme de protection des marchands.',
    'Your PayPal balance remains intact if the customer claims that they did not receive an item.' => 'Votre solde PayPal reste intact si le client prétend qu\'il n\'a pas reçu d\'article.',
    'Your PayPal balance remains intact if the customer claims that they did not receive an item or the account holder claims that they did not authorize the payment.' => 'Votre solde PayPal reste intact si le client prétend qu\'il n\'a pas reçu un article ou si le titulaire du compte prétend qu\'il n\'a pas autorisé le paiement.',
    'Not eligible' => 'Non éligible',
    'Partially eligible' => 'Partiellement éligible',
    'Eligible' => 'Éligible',
    'You are not authorized to refund this order.' => 'You are not authorized to refund this order.',
    'Refund' => 'Remboursement',
    'Payment' => 'Paiement',
    'Total' => 'Total',
    'was not saved for future purchases' => 'n\'a pas été enregistré pour vos achats futurs',
    'was saved for future purchases' => 'a été enregistré pour vos achats futurs',
    'Payment method status' => 'Statut méthode de paiement',
    'If you have any question, please contact us.' => 'Si vous avez une question, veuillez nous contacter.',
    'You will be redirected to an external secured page of our payment gateway.' => 'Vous serez redirigé vers une page externe sécurisé.',
    'Your payment needs to be authenticated, please click the button below.' => 'La transaction nécessite une authentification de votre part, veuillez cliquez sur le lien ci-dessous.',
    'Your payment needs to be approved, please click the button below.' => 'La transaction nécessite une approbation de votre part, veuillez cliquez sur le lien ci-dessous.',
    'Your payment has been declined by our payment gateway, please contact us via the link below.' => 'La transaction a été refusée par la plateforme de paiement, veuillez nous contacter en utilisant le lien ci-dessous.',
    'Authenticate payment' => 'Authentifier le paiemennt',
    'Approve payment' => 'Approuver le paiement',
    'Amount paid' => 'Montant payé',
    'Funding source' => 'Méthode de paiement',
    'Transaction status' => 'Etat de la transaction',
    'Transaction identifier' => 'Identifiant de la transaction',
    'Order status' => 'Etat de la commande',
    'Order identifier' => 'Identifiant de la commande',
    'Payment gateway information' => 'Information de la plateforme de paiement',
    'If you need assistance, please contact our Support Team on PrestaShop Checkout configuration page on Help subtab.' => 'Si vous avez besoin d\'aide, contacter l\'équipe support du module PrestaShop Checkout depuis la page de configuration du module via l\'onglet Aide.',
    'Exception detail:' => 'Identifiant exception :',
    'Exception identifier:' => 'Identifiant d\'exception',
    'PayPal order identifier:' => 'Identifiant de commande PayPal :',
    'Cart identifier:' => 'Identifiant panier : ',
    'Customer identifier:' => 'Identifiant client : ',
    'A customer encountered a processing payment error :' => 'Un client a rencontré une erreur en payant',
    'This message is sent automatically by module PrestaShop Checkout' => 'Ce message est automatiquement envoyé par le module PrestaShop Checkout',
    'This payment method has been refused by the payment platform, please use another payment method.' => 'Ce moyen de paiement a été refusé par la plateforme de paiement, veuillez utiliser un autre moyen de paiement.',
    'Order is already captured.' => 'La commande PayPal a déjà été capturée.',
    'Transaction expired, please try again.' => 'La transaction a expiré, veuillez réessayer.',
    'The transaction failed. Please try a different payment method.' => 'La transaction a échoué. Veuillez utiliser un autre moyen de paiement.',
    'Your country is not supported by this payment method, please try to select another.' => 'Votre pays n\'est pas supporté pour ce moyen de paiement, veuillez en utiliser un autre.',
    'Your card cannot be used to pay in this currency, please try another payment method.' => 'Votre carte ne peut pas être utilisée pour payer dans cette devise, veuillez essayer un autre moyen de paiement.',
    'The CVC code length is invalid for the specified card type.' => 'La longueur du code CVV est incorrect pour ce type de carte.',
    'Processing of this card type is not supported. Use another card type.' => 'Ce type de carte n\'est pas supporté. Veuillez essayer un autre type de carte.',
    'Cart delivery option is unavailable.' => 'L\'option de livraison sélectionnée est indisponible.',
    'Cart delivery address is invalid.' => 'L\'adresse de livraison est invalide.',
    'Cart invoice address is invalid.' => 'L\'adresse de facturation est invalide.',
    'Cart contains product unavailable.' => 'Le panier contient des produits indisponibles.',
    'Cart doesn\'t contains product.' => 'Le panier est vide.',
    'The transaction amount doesn\'t match with the cart amount.' => 'Le montant de transaction ne correspond pas au montant de la commande.',
    'OrderPayment cannot be saved' => 'Le paiement ne peut être enregistré.',
    'OrderState cannot be saved' => 'Le statut de la commande ne peut être mis à jour.',
    'Order cannot be saved' => 'La commande ne peut pas être enregistrée',
    'Cart is invalid' => 'La panier en cours est invalide, veuillez réessayer.',
    'PayPal payment method is missing' => 'Le moyen de paiement par PayPal est manquant',
    'PayPal order identifier is missing' => 'L\'identifiant de commande PayPal est manquant',
    'Unable to call API' => 'Impossible d\'appeler l\'API',
    'This payment method is unavailable' => 'Ce moyen de paiement n\'est pas disponible',
    'The transaction was refused.' => 'La transaction été refusée.',
    'The transaction failed. Please try a different card.' => 'La transaction a échoué. Veuillez essayer une carte différente.',
    'Error processing payment, you could have been charged. Please check your order history in your account to check the status of the order or please contact our customer service to know more.' => 'Erreur lors du processus de paiement, vous avez peut être été débité. Veuillez vérifier votre historique de commande dans votre compte client. Contactez le service client pour en savoir plus.',
    'We encountered an issue while processing your Apple Pay payment. Please verify your order details and try again, or use a different payment method.' => 'Un problème est survenu lors du traitement de votre paiement Apple Pay. Veuillez vérifier les détails de votre commande et réessayer, ou utilisez un autre mode de paiement.',
    'We’re unable to process your Apple Pay payment at the moment. This could be due to an issue verifying the payment setup for this website. Please try again later or choose a different payment method.' => 'Nous ne pouvons pas traiter votre paiement Apple Pay pour le moment. Cela peut être dû à un problème de vérification de la configuration du paiement pour ce site. Veuillez réessayer plus tard ou choisir un autre moyen de paiement.',
    'Card holder authentication cannot be checked, please choose another payment method or try again.' => 'L\'identité du titulaire de la carte n\'a pas pu être vérifiée, veuillez choisir un autre moyen de paiement ou essayez de nouveau.',
    'Card holder authentication failed, please choose another payment method or try again.' => 'Echec de l\'authentification du titulaire de la carte, veuillez choisir un autre moyen de paiement ou essayez de nouveau.',
    'An error occurred on card holder authentication, please choose another payment method or try again.' => 'Une erreur est survenue lors de l\'authentification du titulaire de la carte, veuillez choisir un autre moyen de paiement ou essayez de nouveau.',
    'Card holder authentication canceled, please choose another payment method or try again.' => 'Authentification du titulaire de carte annulée, veuillez choisir un autre moyen de paiement ou essayez de nouveau.',
    'An error occurred fetching Apple Pay payment request' => 'Une erreur est survenue lors de la récupération des informations sur la transaction Apple Pay',
    'An error occurred fetching Google Pay transaction info' => 'Une erreur est survenue lors de la récupération des informations sur la transaction Google Pay',
    'No Apple Pay Javascript SDK Instance' => 'L\'instance du Apple Pay Javascript SDK est manquante',
    'No Google Pay Javascript SDK Instance' => 'L\'instance du Google Pay Javascript SDK est manquante',
    'No PayPal Javascript SDK Instance' => 'L\'instance du PayPal JavaScript SDK est manquante',
    'There was an error during the payment. Please try again or contact the support.' => 'Une erreur s\'est produite lors du paiement. Veuillez réessayer ou contacter le support.',
    'Failed' => 'Échec',
    'Refunded' => 'Remboursée',
    'Partially refunded' => 'Remboursée partiellement',
    'Pending' => 'En attente',
    'Declined' => 'Refusée',
    'Completed' => 'Terminée',
    'Voided' => 'Annulée',
    ...
    'Pay with %s' => 'Payer avec %s',
    'Pay by %s' => 'Payer avec %s',
    'Pay in installments with PayPal Pay Later' => 'Payer en plusieurs fois avec PayPal Pay Later',
    'Pay with a PayPal account' => 'Payer avec un compte PayPal',
    'Pay by Card - 100% secure payments' => 'Payer par Carte',
    'Card' => 'Carte',
    'Go back to the Checkout' => 'Retourner au tunnel de commande',
    ...
    'PayPal' => 'PayPal',
    'You have chosen to pay by Card.' => 'Vous avez choisi de payer par carte.',
    'You have chosen to pay by PayPal.' => 'Vous avez choisi de payer par PayPal.',
    'Here is a short summary of your order:' => 'Voici un résumé de votre commande :',
    'The total amount of your order comes to' => 'Le montant total de votre panier est de',
    '(tax incl.)' => '(TTC)',
    'Please confirm your order by clicking "I confirm my order".' => 'Veuillez finaliser votre commande en cliquant sur "Je valide ma commande"',
    'Delete this payment method?' => 'Voulez-vous supprimer cette méthode de paiement ?',
    'The following payment method will be deleted from your account:' => 'Cette méthode de paiement sera supprimée de votre compte :',
    'Delete payment method' => 'Supprimer cette méthode de paiement',
    ...
    'I confirm my order' => 'Je valide ma commande',
    'Thanks for your purchase!' => 'Merci pour votre achat !',
    'Please wait, we are processing your payment' => 'Veuillez patienter, nous traitons votre paiement',
    'This is taking longer than expected. Please wait...' => 'Veuillez patienter, cela prend un peu plus de temps...',
    'Ok' => 'Ok',
    'Cancel' => 'Annuler',
    '100% secure payments' => 'Paiement 100% sécurisé',
    'or' => 'ou',
    'Express Checkout' => 'Achat rapide',
    'Unable to find PayPal Order associated to this PrestaShop Order [PRESTASHOP_ORDER_ID]' => 'Impossible de trouver la commande PayPal associée à cette commande PrestaShop.',
    'This PrestaShop Order [PRESTASHOP_ORDER_ID] is not paid with PrestaShop Checkout' => 'Cette commande PrestaShop [PRESTASHOP_ORDER_ID] n\'a pas été payée avec PrestaShop Checkout',
    'PayPal Order [PAYPAL_ORDER_ID] is not in the same environment as PrestaShop Checkout' => 'La commande PayPal [PAYPAL_ORDER_ID] n\'est pas disponible sur cet environnement (production ou test sandbox).',
    'It seems your employee token is invalid.' => 'Votre token d\'authentification employé est expiré.',
    'It seems you are logged out.' => 'Vous n\'êtes plus connecté.',
    'Your PayPal Merchant identifier seems invalid.' => 'Votre identifiant marchand PayPal est invalide.',
    'We didn\'t receive your PayPal Merchant identifier.' => 'Nous n\'avons pas reçu votre identifiant marchand PayPal.',
    'Environment' => 'Environnement',
    'Test' => 'Test',
    'Transaction details are not available' => 'Les détails de la transaction ne sont pas disponibles',
    'Seller protection' => 'Protection des marchands',
    'Refund transaction totally or partially' => 'Rembourser partiellement ou totalement la transaction',
    'The environment in which the transaction was made: Test or Production' => 'L\'environnement utilisé pour cette transaction: Test ou Production',
    'The bank issuer accepted the liability shift. You can safely honor the order.' => 'La banque émettrice a accepté le transfert de responsabilité. Vous pouvez honorer la commande en toute sécurité.',
    'Transaction details' => 'Détails de la transaction',
    'Your transaction refund request will be sent to PayPal. After that, you’ll need to manually process the refund action in the PrestaShop order: choose the type of refund (standard or partial) in order to generate credit slip.' => 'Votre demande de remboursement va être transmise à PayPal. Ensuite, vous devrez enregistrer le remboursement dans la commande PrestaShop : choisir le type de remboursement (standard ou partiel) pour générer un avoir.',
    'Success' => 'Succès',
    'Fees (Tax Incl.)' => 'Commission (TTC)',
    'PayPal Order' => 'Commande PayPal',
    'The bank issuer declined the liability shift. We advice you not to honor the order immediately, wait a few days in case of chargeback and contact the consumer to ensure authenticity of the transaction. For this type of cases we also recommend to consider Chargeback protection.' => 'La banque émettrice a décliné le transfert de responsabilité. Nous vous recommandons de ne pas honorer la commande immédiatement et de patientez quelques jours en cas de rétro-facturation. Prenez contact avec l\'acheteur pour vérifier l\'authenticité de la transaction. Pour ce type de cas, nous vous recommandons également de considérer la Protection contre les oppositions bancaires de PayPal.',
    'This PayPal Order has been reversed.' => 'La commande PayPal a été reversée.',
    'The PayPal account that was used to create this order is no longer linked to the PrestaShop Checkout module.' => 'Le compte PayPal qui a été utilisé pour créer cette commande n\'est plus lié au module PrestaShop Checkout.',
    'Reference' => 'Référence',
    'Exempted' => 'Exempté',
    'See on PayPal' => 'Aller sur Paypal',
    'Production' => 'Production',
    'Any change on the order?' => 'Une modification de commande ?',
    'Gross amount' => 'Montant brut',
    'Net amount' => 'Montant net',
    'In order to see this information, please reconnect the correct PayPal account.' => 'Pour voir ces informations, veuillez reconnecter le compte PayPal concerné.',
    'Your 3D Secure settings for this transaction were set to "Strong Customer Authentication (SCA) when required", but the current transaction does not require it as per the regulation.' => 'Vos paramètres 3D Secure pour cette transaction ont été définis sur "Exiger une authentification forte du client lorsque cela est nécessaire", mais la transaction actuelle n’en nécessite pas selon la réglementation.',
    'Merchant' => 'Marchand',
    'Balance' => 'Solde',
    'This PayPal Order has been canceled.' => 'La commande PayPal a été annulée.',
    'Amount (Tax incl.)' => 'Montant (TTC)',
    'Total amount you will receive on your bank account: the order amount, minus transaction fees, minus potential refunds' => 'Montant à recevoir sur votre compte bancaire : total de la commande moins la commission et les remboursements éventuels',
    'Go to PrestaShop Checkout' => 'Aller à PrestaShop Checkout',
    'Learn more' => 'En savoir plus',
    'Transaction amounts' => 'Montant de la transaction',
    'Maximum [AMOUNT_MAX] [CURRENCY] (Tax incl.)' => 'Maximum [AMOUNT_MAX] [CURRENCY] (TTC)',
    'Amount (Tax Incl.)' => 'Montant (TTC)',
    'Liability shift' => 'Transfert de responsabilité',
    'Payment mode' => 'Moyen de paiement',
    'Bank' => 'Banque',
    'Status' => 'Statut',
    '3D Secure' => '3D Secure',
    'Net amount to refund' => 'Montant net à rembourser',
    'Card does not support 3D Secure' => '3D Secure non prit en charge par la carte',
    'Order details' => 'Détails de la commande',
    'Confirm refund' => 'Confirmer le remboursement',
    'Maximum [AMOUNT_MAX] [CURRENCY] (tax included)' => 'Maximum [AMOUNT_MAX] [CURRENCY] (TTC)',
    'Card holder name is invalid' => 'Nom du titulaire de la carte invalide.',
    '3-digits' => '3 chiffres',
    'Card vendor is invalid' => 'Marque de la carte non prise en charge.',
    'code on the back of your credit card. In some cases, it can be 4-digits or on the front of your card.' => 'présent sur le dos de votre carte. Dans certains cas, il est composé de 4 chiffres ou se trouve à l\'avant de la carte.',
    'CVV code is invalid' => 'Code de sécurité invalide.',
    'Card expiration date' => 'Date d\'expiration',
    'Card expiration date is invalid' => 'Date d\'expiration de la carte invalide.',
    'Card number is invalid' => 'Numéro de carte invalide.',
    'Cardholder Name (optional)' => 'Nom du titulaire de la carte',
    'The security code is a' => 'Le code de sécurité est un code à',
    'Go back to module configuration' => 'Retourner à la configuration du module',
    'An error occurred on PayPal Onboarding, please try again.' => 'La connexion a votre compte PayPal a échoué.',
    'Your order is waiting for payment confirmation. You will receive an email when your payment has been validated. You can also check the order status in your order history in your account.' => 'Votre commande est en attente de confirmation de paiement. Vous recevrez un email lorsque votre paiement aura été validé. Vous pouvez également vérifier le statut de votre commande dans votre historique de commandes dans votre compte.',
    'Your order is confirmed.' => 'Votre commande est confirmée.',
    'Processing payment canceled, please choose another payment method or try again.' => 'Traitement du paiement annulé, veuillez choisir une autre méthode de paiement ou essayez de nouveau.',
    'Pay by card' => 'Payer par Carte',
    'The customer must resolve the contingency before the payment can be processed.' => 'Le client doit résoudre la contingence avant de pouvoir traiter ce paiement.',
    'Order has previously been saved. Please contact customer service to check that your order has successfully been validated. ' => 'Commande déjà validée. Veuillez contacter le service client pour vérifier que votre commande a été validée avec succès.',
    'You skipped 3D Secure validation, please try again or try another payment method.' => 'Vous avez passer la vérification 3D Secure, veuillez essayer de nouveau ou essayer un autre moyen de paiement.',
    'The merchant account is restricted. Please try later or contact customer service to process your order.' => 'Le compte du marchand est limité. Veuillez essayer plus tard ou contacter le service client pour traiter votre commande.',
    'Please save the order by calling v2/orders/{order_id}/save or alternately, If you don\'t intend to save the order, PATCH the order to update the value of `processing_instruction` to NO_INSTRUCTION.' => 'Veuillez enregistrer la commande en appelant v2/orders/{order_id}/save ou, si vous ne souhaitez pas l\'enregistrer, faites un PATCH de la commande pour mettre à jour la valeur de `processing_instruction` à NO_INSTRUCTION.',
    'The requested agreement is already canceled. This error occurs when the agreement for an authorized payment or captured payment is already canceled.' => 'L\'accord demandée est déjà annulée. Cette erreur arrive lorsque l\'accord pour un paiement autorisé ou paiement capturé est déjà annulé.',
    'Authorization amount exceeds allowable limit. Please provide the authorization amount within allowable limit and try again.' => 'Le montant d\'autorisation dépasse la limite autorisée. Fournir un montant d\'autorisation dans les limites autorisées et essayer de nouveau.',
    'This order has been previously voided and cannot be voided again. Verify the order id and try again.' => 'Cette commande a déjà été annulée et ne peut pas être annulée de nouveau. Vérifier la référence de commande et essayer de nouveau.',
    'Card processing payment error, please try again or try another payment method.' => 'Erreur en traitant le paiement par carte, veuillez essayer de nouveau ou essayer un autre moyen de paiement.',
    'Payee account is not setup to be able to process card payments. Please contact PayPal customer support.' => 'Le compte marchand n\'est pas configuré pour accepter les paiements par carte. Veuillez contacter le service client PayPal.',
    'The value of a field is invalid.' => 'La valeur d\'un des champs est invalide.',
    'The card number, the expiry date or the CVV is invalid. Please verify all three and try again.' => 'Le numéro de carte, la date d\'expiration ou le code de sécurité est invalide. Vérifiez les et essayez de nouveau.',
    'The amount cannot be updated as the `payer` has chosen and approved a specific financing offer for a given amount. Please Create a new Order with the updated Order amount and have the `payer` approve the new payment terms. ' => 'The amount cannot be updated as the `payer` has chosen and approved a specific financing offer for a given amount. Please Create a new Order with the updated Order amount and have the `payer` approve the new payment terms. ',
    'That transaction has been blocked by Fraud Protection rules. Please try another card or contact customer service to process your order or change their Fraud Protection rules.' => 'Cette transaction a été bloquée par les règles de protection anti-fraude. Veuillez utiliser une autre carte ou contacter le service client pour traiter votre commande ou pour changer les règles anti-fraude du compte bancaire.',
    'This transaction is currently not supported. Please contact customer service or your account manager for more information.' => 'Cette transaction n\'est pas possible. Merci de contacter le service client ou votre gestionnaire de compte pour plus d\'informations.',
    'The number of items in an array parameter is too small.' => 'Le nombre de caractères d\'un des paramètres est trop faible.',
    'That currency is not supported with that payment option. Please try with another currency or contact customer support.' => 'Cette devise n\'est pas pris en charge par cette méthode de paiement. Veuillez essayer avec une autre devise ou contacter le service client.',
    '3D Secure validation failed, please try again or try another payment method.' => 'La vérification 3D Secure a échoué, veuillez essayer de nouveau ou essayer un autre moyen de paiement.',
    'The option to save an order is only available if the order has a single purchase unit.  Please create an order with a single purchase unit and try again.' => 'L\'option d\'enregistrement d\'une commande est disponible seulement si la commande ne contient qu\'une seule unité d\'achat. Veuillez créer une commande avec une unique unité d\'achat et essayer de nouveau.',
    'Order does not have a corresponding matching reference_id. Please provide a valid reference_id and try again.' => 'La commande ne détient pas un reference_id correspondant. Veuillez fournir a reference_id valide et essayer de nouveau.',
    'The parameter value does not conform to the expected `YYYY-MM` format.' => 'The parameter value does not conform to the expected `YYYY-MM` format.',
    'Specified resource ID does not exist. Please check the resource ID and try again.' => 'La référence de ressource spécifiée n\'existe pas. Vérifier la référence de ressource et essayer de nouveau.',
    'Order already authorized. Only one authorization per order is allowed. Please contact customer service to check that your order has successfully been validated.' => 'Commande déjà autorisée. Seulement une autorisation par commande est possible. Contacter le service client pour vérifier que votre commande a bien été validée avec succès.',
    'This payment instruction is supported only when `intent=CAPTURE`. If intent is `AUTHORIZE`, you must provide the payment instruction when the authorization is captured. For details, see Capture authorization.' => 'This payment instruction is supported only when `intent=CAPTURE`. If intent is `AUTHORIZE`, you must provide the payment instruction when the authorization is captured. For details, see Capture authorization.',
    'A required parameter is missing. Please check that every personnal and delivery details are filled and try again.' => 'Un paramètre requis est manquant. Veuillez vérifier que tous les champs d\'informations personnelles et de livraison sont remplis et essayer de nouveau.',
    'Invalid order intent.' => 'Intention de commande invalide.',
    'The card is expired. Please use another card.' => 'La carte de crédit est expirée. Veuillez utiliser une autre carte.',
    'Processing of this card brand is not supported. Use another type of card.' => 'Le traitement de ce type de carte n\'est pas pris en charge. Utiliser un autre type de carte.',
    'Threeds Secure Parameters are empty.' => 'Threeds Secure Parameters are empty.',
    'Currency code not supported for direct card payments using this card type. Please refer https://developer.paypal.com/docs/integration/direct/rest/currency-codes/ for list of supported currency codes.' => 'Devise non prise en charge pour les paiements par carte pour ce type de carte. Se référer à https://developer.paypal.com/docs/integration/direct/rest/currency-codes/ pour la liste des devises supportées.',
    'Order already captured. Only one capture per order is allowed. Please contact customer service to check that your order has successfully been validated.' => 'Commande déjà validée. Une seule capture peut être effectuée par commande. Veuillez contacter le service client pour vérifier que votre commande a été validée avec succès.',
    'Expiration year must be between now and 2099' => 'La date d\'expiration doit être comprise entre maintenant et 2099',
    '3D Secure processing validation error, please try again or try another payment method.' => 'Erreur en traitant la vérification 3D Secure, veuillez essayer de nouveau ou essayer un autre moyen de paiement.',
    'The API Caller account is not setup to be able to process card payments. Please contact PayPal customer support.' => 'Le API Caller account n\'est pas configuré pour accepter les paiements par carte. Veuillez contacter le service client PayPal.',
    'Processing of this card type is not supported. Use another type of card.' => 'Le traitement de ce type de carte n\'est pas pris en charge. Veuillez utiliser un autre type de carte.',
    'The transaction is declined due to a compliance violation.' => 'Cette transaction est refusée pour des raisons de violation de conformité.',
    'The client is not allowed to use `payment_instruction` object.' => 'Ce client n\'est pas autorisé à utiliser  l\'objet "payment_instriction".',
    'The currency of the authorization should be same as that in which the Order was created and approved by the Payer. Please check the `currency_code` and try again.' => 'La devise de l\'autorisation de paiement doit être la même que la devise utilisée pour créer la commande et autorisée par le client. Vérifier le "currency_code" et essayer de nouveau.',
    'The customer has not approved payment.' => 'Le client n\'a pas approuvé le paiement.',
    ...
    'The order was created with an intent of `AUTHORIZE`. To complete authorization, use `/v2/checkout/orders/{order_id}/authorize`. Or, alternately create an order with an intent of `CAPTURE`.' => 'The order was created with an intent of `AUTHORIZE`. To complete authorization, use `/v2/checkout/orders/{order_id}/authorize`. Or, alternately create an order with an intent of `CAPTURE`.',
    'PrestaShop Checkout transactions won\'t work in some of your configured countries, but there is a solution !' => 'PrestaShop Checkout ne fonctionnera pas dans certains de vos pays configurés, mais il y a une solution !',
    'Change currencies activation for this payment module' => 'Changer les devises activées pour ce module de paiement',
    'Change countries activation for this payment module' => 'Changer les pays activés pour ce module de paiement',
    'Please upgrade your settings for :' => 'Veuillez modifier votre configuration pour :',
    'Know more about compliant ISO Codes' => 'En savoir plus sur les ISO Codes conformes',
    'PrestaShop Checkout transactions won\'t work in some of your configured currencies, but there is a solution !' => 'PrestaShop Checkout ne fonctionnera pas avec certaines de vos devises configurées, mais il y a une solution !',
    '3DS verification failed, please try again.' => 'L\'authentification 3D secure a échoué, veuillez réessayer.',
    'Back to order page' => 'Retour à la page de commande',
    'One module, all payments methods.' => 'Un module, tous les moyens de paiement.',
    'Offer the widest range of payment methods: cards, PayPal, etc.' => 'Offrez le plus grand nombre de moyens de paiement : carte, PayPal, etc.',
    'Benefit from all PayPal expertise and advantages' => 'Bénéficiez de l\'expertise et de tous les avantages de PayPal',
    'Give access to relevant local payment methods for customers around the globe' => 'Donnez accès à tous les moyens de paiement locaux préférés de vos clients à travers le monde',
    'Including:' => 'Inclus : ',
    'Configure' => 'Configurer',
    'Warning' => 'Attention',
    'You have selected your [PAYPAL_ACCOUNT] PayPal account to proceed to the payment.' => 'Vous avez choisi le compte PayPal [PAYPAL_ACCOUNT] pour effectuer le paiement.',
    'Please wait, loading additional payment methods.' => 'Veuillez patienter, chargement de modes de paiement supplémentaires.',
    'Are you sure you want to uninstall this module?' => 'Etes-vous sûr de vouloir désinstaller ce module ? Attention vous aller perdre les données associées à vos précédentes commandes !',
    'Choose another payment method' => 'Choisir un autre moyen de paiement',
    'Accept payments through PayPal buttons on your checkout page.' => 'Acceptez les paiements via le bouton PayPal sur votre page de finalisation de commande',
    'Gold version shows better results on conversion rate' => 'La version Or a démontré un meilleur taux de conversion.',
    'Express Checkout Shortcut allows merging account creation and payment, to make your customers purchases effortless.' => 'Le raccourci Express Checkout permet de fusionner création de compte et paiement pour faciliter les achats de vos clients.',
    'Link to PrestaShop Checkout first' => 'Commencez par lier un compte PrestaShop Checkout ',
    'Enabled' => 'Activé',
    'Manage conversion rules' => 'Gérer les règles de conversions',
    'Local payment methods' => 'Moyens de paiement locaux',
    'Higher conversions' => 'Un meilleur taux de conversion',
    'Contact us' => 'Nous contacter',
    'Define the currency conversion rules' => 'Définir les règles de conversion de devises',
    'Pending transaction' => 'Transaction(s) en attente',
    'Help for PrestaShop Checkout' => 'Aide pour PrestaShop Checkout',
    'Displaying this message has shown a better conversion rate and a raise of Average Order Value.' => 'Afficher ces messages a montré un meilleur taux de conversion et un panier moyen plus élevé.',
    'Back' => 'Retour',
    'Business information' => 'Informations d\'entreprise',
    'Actions' => 'Actions',
    'Email already exist.' => 'L\'email existe déjà.',
    'One more thing : send documents to be fully approved by PayPal' => 'Une dernière chose : envoyez vos documents pour que votre compte PayPal soit totalement validé par PayPal.',
    'The email is missing.' => 'L\'email est manquant.',
    'in the meantime, you can sell now up to 500$ in card transactions.' => 'Entre temps, vous pouvez dès à présent accepter les paiements par carte jusqu\'à un total de 500€',
    'Credit and Debit Cards' => 'Cartes de crédit',
    'Unfortunately, credit card payments cannot be processed for you at the moment. In the meantime, you can still receive payments via PayPal. Please proceed to some actions from your PayPal account, where you should have received a notification. If not, please contact PayPal help center.' => 'Malheureusement, les cartes de crédit ne peuvent pas être acceptées pour le moment. Entre temps, vous pouvez accepter les paiements par PayPal. Veuillez effectuer certaines actions sur votre compte PayPal, où vous avez certainement reçu une notification. Si ce n\'est pas le cas, veuillez contacter le service client PayPal.',
    'Your PrestaShop account is linked to your PayPal account' => 'Votre compte PrestaShop est maintenant connecté à votre compte PayPal',
    'in card transactions until your account is fully approved' => 'en transactions par carte tant que votre compte est en attente de validation',
    'Link to PayPal account' => 'Lier un compte PayPal',
    'Discount' => 'Réduction',
    'Button configuration saved with success !' => 'Configuration des boutons sauvegardée avec succès !',
    'Shipping costs, if any, will be estimated in basket total. Delivery method selected by default will be the one set in first position on Carriers page.' => 'Les frais de port, si ils existent, seront estimé dans le panier. La méthode de livraison par défaut sera celle en première position sur la page transporteurs. ',
    'Send it again' => 'Envoyer à nouveau',
    'Production mode enables you to collect your payments.' => 'Le mode production vous permet d\'encaisser de l\'argent',
    'The password is invalid.' => 'Le mot de passe n\'est pas valide.',
    'except opposition here' => 'sauf opposition ici',
    'Website' => 'Site',
    'If approval is pending or issues are encountered with the Integrated fields, you can activate these fields as a backup, only if Integrated fields are not available or deactivated. The fees are the same as PayPal payment method.' => 'Si la validation de votre compte PayPal tarde, ou que vous rencontrez des problèmes de paiement avec les Champs de Carte Intégrés, vous pouvez activer ces champs alternatifs, comme solution temporaire, seulement si les Champs de Carte Intégrés sont indisponibles ou désactivés. Les comissions appliquées sont les mêmes que pour le paiement par PayPal.',
    'Loading' => 'Chargement',
    'There are no payment methods available. You can\'t receive payments from PayPal right now and your customers can\'t proceed to payments (anymore) via the payment methods provided by PrestaShop Checkout.' => 'Aucun moyen de paiement n\'est disponible. Vous ne pouvez pas recevoir de paiements de PayPal pour le moment et vos clients ne peuvent pas (plus) procéder à des paiements via les moyens de paiement fournis par PrestaShop Checkout.',
    'Connect your PrestaShop Checkout account and link your PayPal Account or create one if needed' => 'Connecter votre compte PrestaShop Checkout et lier votre compte PayPal ou créez en un si besoin',
    'What is the difference between Integrated Credit Card fields and PayPal branded Credit Card Fields ?' => 'Quelle est la différence entre entre les Champs de Carte Intégrés et les Champs de Carte Alternatifs de Paypal ?',
    'Conversion rules' => 'Règles de conversion',
    'Process unlimited card payments. You can accept either credit or debit card.' => 'Recevez des paiements par carte sans limite. Vous pouvez accepter les paiements par carte de crédit et de débit.',
    'The capability can no longer be used, but there are remediation steps to regain access to the corresponding functionality.' => 'Les fonctionnalités ne peuvent plus être utilisées, mais il existe des étapes pour récupérer les accès aux fonctionnalités correspondantes',
    'Manage currencies' => 'Gérer les devises',
    'Create your PrestaShop Checkout account' => 'Créer votre compte PrestaShop Checkout',
    'Your account needs to be validated to accept PayPal payments. Please check your inbox for any email confirmation.' => 'Votre compte doit être validé pour accepter les paiements via PayPal. Veuillez jeter un œil à votre boite de réception pour confirmer votre adresse email.',
    'Boost your conversion rate by displaying PayPal as the first choice in the list of payment methods' => 'Optimisez votre taux de conversion en positionnant PayPal comme première option',
    'You’ve got an email.' => 'Vous avez un email.',
    'Billing address' => 'Adresse de facturation',
    'PayPal button' => 'Bouton PayPal',
    'FAQ' => 'FAQ sur les comptes déclinés',
    'Account declined FAQs' => 'FAQ sur les comptes déclinés',
    'First name' => 'Prénom',
    'Subtotal' => 'Sous-total',
    'Credit Card availability revoked' => 'Disponibilité de la carte de crédit révoquée.',
    'Alternative Credit Card Fields activation' => 'Activation des champs de carte de crédit alternatifs',
    'Personal information' => 'Informations personnelles',
    'Company estimated monthly turnover' => 'Chiffre d\'affaires mensuel estimé de l\'entreprise',
    'White' => 'Blanc',
    'Roundings settings to change' => 'Paramètres d\'arrondis à mettre à jour',
    'Handling' => 'Frais de manutention',
    'Download PDF' => 'Télécharger le Guide utilisateur',
    'Choose page location for messages' => 'Choisissez l\'emplacement des messages sur la page',
    'Congrats ! You can start selling online now.' => 'Félicitations ! Vous pouvez désormais recevoir des paiements.',
    'Set up description' => 'Choisir la description',
    'Be careful, your roundings settings are not fully compatible with PrestaShop Checkout transaction processing. Some of the transactions could fail. But it is easy, your setting Round mode and Round type should be set on « Round up away from zero, when it is half way there » and « Round on each item » or click on the button bellow to make it automatically !' => 'Attention, vos paramètres d\'arrondi ne sont pas totalement compatibles avec le traitement des transactions PrestaShop Checkout. Certaines des transactions pourraient échouer. Mais c’est facile, vos réglages «Règle d\'arrondi» et «Type d\'arrondi» doivent être réglés sur «Arrondir vers l\'infini quand valeur à mi-chemin» et «Arrondir pour chaque article» ou cliquer sur le bouton ci-dessous pour le faire automatiquement!',
    'TIPS' => 'CONSEIL',
    'Multistore detected' => 'Mode Multiboutique detecté',
    'Customize PayPal button' => 'Personnaliser le bouton PayPal',
    'Mr' => 'M',
    'per transaction depending on your country. ' => 'par transaction, selon votre pays.',
    'Not available' => 'Non Disponible',
    'Adjust your bank account' => 'Ajouter votre compte bancaire',
    'Connect your PrestaShop account' => 'Connecter votre compte PrestaShop',
    'available in :' => 'Disponibilité :',
    'Production mode' => 'Mode Production',
    'Customize checkout experience' => 'Personnaliser l\'experience d\'achat',
    'Preview' => 'Prévisualisation',
    'Homepage' => 'Page d\'accueil',
    'This module allows you to:' => 'Ce module vous permet de :',
    'PayPal algorithms automatically limit your fraud rate. There is a complete tool on PayPal to set specific rules and drive your performance concerning fraud and chargeback costs.' => 'Les algorithmes de PayPal limite automatiquement le nombre de fraudes. Il existe un outil complet sur l\'interface PayPal pour configurer des règles spécifiques et piloter votre performance concernant la fraude et les surcoûts de recouvrement.',
    'Manage Activity' => 'Gérer l\'activité',
    'Transaction type' => 'Type de transaction',
    'Change payment methods order' => 'Changer l\'ordre des moyens de paiement',
    'Offer the widest range of payment methods: cards, PayPal, etc...' => 'Offrir le plus large choix de moyens de paiement : cartes, PayPal, etc …',
    ' ) : we highly recommend to use these ones, by default. But you need PayPal full approval for accepting Credit Cards payment with the fields. You can see the status of this approval in the ' => ') : nous vous recommandons de les privilégier. Votre compte PayPal doit avoir été totalement approuvé afin d\'en bénéficier. Vous pouvez voir le statut d\'approbation de votre compte PayPal dans le',
    'Please select the first shop to configure from the list below :' => 'Veuillez sélectionner une boutique dans la liste ci-dessous.',
    'Test mode is turned on' => 'Le mode test est activé',
    'Reset password' => 'Réinitialiser le mot de passe',
    'A confirmation email has been sent. Check your inbox and click on the link to activate your account.' => 'Un email de confirmation a été envoyé. Vérifiez votre boite de réception et cliquez sur le lien pour activer votre compte.',
    'Use production mode' => 'Activer le mode production',
    'up to $500' => 'jusqu\'à 500$',
    'Integrated Credit Card Fields' => 'Champs de Carte Intégrés',
    'Change countries ISO Codes' => 'Changer les ISO codes pays',
    'Payment methods acceptance' => 'Moyens de paiements acceptés',
    'Create account' => 'Créer un compte',
    'Test mode' => 'Mode test',
    'An error during configuration was detected. Please reset the PrestaShop Checkout module and configure it again.' => 'Erreur de configuration détectée, veuillez réinitialiser le module et le configurer à nouveau.',
    'Read more' => 'En savoir plus',
    'Log out' => 'Se déconnecter',
    'pending dispute(s)' => 'litige(s) en attente',
    'Terms and Conditions of Use of PrestaShop Checkout' => ' Conditions générales d\'utilisation de PrestaShop Checkout',
    'Date' => 'Date',
    'Each shop must be configured separately, even if you configure the same account on all of them.' => 'Chaque boutique doit être configurée séparemment, même si vous utiliser le même compte pour chacune d\'entres elles.',
    'State' => 'Etat',
    'PrestaShop Checkout account' => 'Compte PrestaShop Checkout',
    'Authorize process holds all payments on customers’ account. Mark the order as « Shipped » or « Payment accepted » to capture payments. Local Payment Methods are not compatible with Authorize process.' => 'Le mode Prélever à l\'expédition conserve l\'argent sur le compte du client. Marquez la commande comme Expediée ou Paiement accepté pour prélever l\'argent. Les moyens de paiement locaux ne sont pas compatibles avec le mode Prélever à l\'expédition',
    'You need to connect to both PrestaShop and PayPal accounts to activate all payment methods' => 'Vous devez connecter des comptes PrestaShop et PayPal pour activer tous les moyens de paiement',
    'Language' => 'Langue',
    'Tax' => 'Taxe',
    'Integrated Credit Card fields provide the best payment experience you can find in PrestaShop. Well integrated in your checkout process, not branded, with the fewest number of fields, and lowest fee rates (see them on ' => 'Les Champs de Carte Intégrés proposent la meilleure expérience d\'achat sur PrestaShop. Bien intégrés dans le parcours d\'achat, sans marque, avec un nombre réduits de champs, et les frais de comissions les plus bas, (voir sur ',
    'See below the transactions processed with PrestaShop Checkout, limited to the last 1000 to load them faster.' => 'Vous trouverez ci-dessous toutes les transactions effectuées à travers PrestaShop Checkout, dans la limite de 1000, pour des raisons de rapidité de chargement.',
    'Reset' => 'Réinitialiser',
    'Configure your bank statements description' => 'Configurer votre description de relevé bancaire',
    'Pill' => 'Pilule',
    'Note that you cannot collect payments with test mode' => 'Notez que vous ne pouvez pas encaisser d\'argent en mode test',
    'please check our list of customizable settings' => 'veuillez consulter notre liste de paramètres personnalisables',
    'Business type' => 'Type d\'entreprise',
    'No confirmation email?' => 'Pas d\'email de confirmation ?',
    'Country' => 'Pays',
    'PayPal account' => 'Compte PayPal',
    'We recommend « Capture at shipping » if you are a lean manufacturer or a craft products seller' => 'Nous recommandons Prélever à l\'expédition si vous vendez des produits artisanaux ou produits à l\'achat.  ',
    'To test your payment method you can make a real transaction (prefer small amount), and once you have observed the money on your account, make a refund on the corresponding order page. Warning, you will not recover the fees.' => 'Pour tester vos méthodes de paiement, procéder à un paiement en privilégiant les petits montants, dès la commande est effectuée, procéder à un remboursement sur la page commande. Attention, vous ne pourrez pas récupérer les frais de commissions.',
    'Errors' => 'Erreurs',
    'Starting from' => 'A partir de',
    'Account declined' => 'Compte décliné',
    'Adjust shape for all buttons' => 'Ajuster la forme pour tous les boutons',
    'Your account needs further checks to accept Credit and Debit Cards payment.' => 'Votre compte nécessite plus de vérifications pour accepter les paiements par carte.',
    'Recommended' => 'Recommandé',
    'Competitive and transparent fees' => 'Des frais compétitifs et transparents',
    'Additional information is required to complete background check. Please go on your www.paypal.com account and check the notification bell on the top right to know which documents are needed. It could be:' => 'Des informations complémentaires sont requises pour effectuer des vérifications. Veuillez vous rendre sur votre compte www.paypal.com et jetez un œil aux notifications sur la cloche en haut à droite pour savoir quels documents supplémentaires sont nécessaires. Cela peut être : ',
    'Help' => 'Aide',
    'Submit idea' => 'Soumettre une idée',
    'Fraud tool' => 'Outil de gestion des fraudes',
    'Change rounding settings' => 'Changer les configurations d\'arrondis',
    'Define PayPal express checkout flow' => 'Définir l\'expérience de l\'express checkout PayPal',
    'Choose page location' => 'Choisir le positionnement sur les pages',
    'PayPal Branded Credit Card Fields' => 'Champs de carte de crédit de PayPal',
    'Log in with your PrestaShop Checkout account' => 'Connectez-vous avec votre compte PrestaShop Checkout',
    'Please contact PayPal Customer Service' => 'Veuillez contacter le service clientèle de PayPal',
    'Know more about my account approval' => 'En savoir plus sur l\'approbation de mon compte',
    'Error, try later.' => 'Une erreur est survenue, veuillez réessayer plus tard.',
    'Available' => 'Disponible',
    'I agree to the ' => 'J\'accepte les ',
    'Details for Bank statements' => 'Details pour relevés bancaires',
    '(merchant ID {0})' => '(merchant ID {0})',
    'pending' => 'En attente',
    'Additional Details' => 'Informations additionnelles',
    'Limit your fraud rate' => 'Limitez votre taux de fraude',
    'Bank account' => 'Compte en banque',
    'Mrs' => 'Mme',
    'Credit Card availability suspended' => 'Disponibilité de la carte de crédit mise en suspens',
    'As soon as PayPal gets all your documents, you\'ll have to wait 48h for final approval.' => 'Patientez environ 48h pour la validation de vos documents par PayPal.',
    'All transactions' => 'Toutes les transactions',
    'You can process' => 'Vous pouvez opérer',
    'Sign in or login to provide every payment method to your customer.' => 'Connectez-vous ou créez un compte pour fournir tous les moyens de paiement à vos clients.  ',
    'Activation status' => 'Statut d\'activation',
    'Forgot password?' => 'Mot de passe oublié ?',
    'Settings updated !' => 'Configurations mis à jour !',
    'An error occured, the PayPal sign up or login window can\'t be opened. Please wait a bit and click again.' => 'Une erreur s\'est produite, la popup de PayPal pour se connecter ne peut pas être ouverte. Merci d\'attendre un peu et de cliquer à nouveau.',
    'The email address is badly formatted.' => 'L\'email n\'a pas le bon format.',
    'Credit Card information, bank account information and ID card' => 'Information de carte de crédit, information de compte en banque, pièce d\'identité, ...',
    'By submitting this form, I agree that the data provided may be collected by PrestaShop S.A to create your PrestaShop Checkout account. By creating your account, you will receive commercial prospecting from PrestaShop' => 'En soumettant ce formulaire, vous acceptez que votre adresse mail soit utilisée par PrestaShop S.A pour créer un compte Checkout. En créant votre compte, vous recevrez de la prospection commerciale de la part de PrestaShop',
    'Logging out will deactivate all payment methods. You will no longer be able to receive payments with PrestaShop Checkout.' => 'La déconnexion désactivera tous les modes de paiement. Vous ne pourrez plus recevoir de paiements avec PrestaShop Checkout.',
    'Choose page location for buttons' => 'Choisissez l\'emplacement des boutons sur la page',
    'You can choose the type of credit card fields only if Credit card is activated in « Customize checkout experience » tab.' => 'Vous pouvez activer les champs de carte de crédit alternatifs uniquement si le mode de paiement Carte Bancaire est activé dans l\'onglet Personnaliser l\'expérience d\'achat.',
    'Postcode' => 'Code postal',
    'Suspended' => 'Suspendu',
    'Background check is currently undergoing' => 'Des vérifications supplémentaires sont en train d\'être réalisées',
    'Last name' => 'Nom de famille',
    'Sign up on order page' => 'Etape de connexion du tunnel de commande',
    'Order Id' => 'Référence de commande',
    'Fill out the form to complete registration:' => 'Remplissez le formulaire pour compléter l\'inscription:',
    'Commission' => 'Commission',
    'We will send you a link to reset your password.' => 'Nous allons vous envoyer un lien pour réinitialiser votre mot de passe.',
    'PrestaShop Checkout 2.0' => 'PrestaShop Checkout 2.0',
    'Setup fraud tool' => 'Configurer l\'outil de fraude',
    'Live' => 'Actif',
    'Blue' => 'Bleu',
    'Business phone' => 'Téléphone d\'entreprise',
    'Gold' => 'Or',
    'Use another account' => 'Utiliser un autre compte',
    'You are now logged in with your' => 'Vous êtes maintenant connecté avec votre compte ',
    'An agency' => 'Une agence',
    'You\'re all set !' => 'Vous êtes prêt !',
    'Information needed' => 'Informations requises',
    'Your rounding settings are now fully compatible' => 'Vos configurations d\'arrondis sont maintenant compatibles',
    'This feature availability is based on eligibility criteria.' => 'La disponibilité de cette fonctionnalité est soumise à des critères d\'éligibilité.',
    'Once you are done with the first shop, you can configure the others: select them one by one with the shop selector, in the horizontal menu.' => 'Une fois que vous aurez configuré la première boutique, vous pourrez configurer les autres : sélectionnez les une par une avec le sélecteur de boutique, dans le menu horizontal.',
    'Continue' => 'Continuer',
    'Tips' => 'Conseil',
    'The capability can no longer be used and there are no remediation steps available to regain the functionality.' => 'Les fonctionnalités ne peuvent plus être utilisées, et il n\'existe pas de solution pour récupérer ces permissions.',
    'Type' => 'Type',
    'Before commission' => 'Avant commission',
    'It can take several days. If further information is needed, you will be notified. Please check your emails or your notification bell on the top right of your www.paypal.com account and follow the instructions.' => 'Cela peut prendre plusieurs jours. Si de plus amples informations sont requises, vous serez notifié. Veuillez suivre vos emails ou la cloche de notification sur votre compte www.paypal.com en haut à droite, et suivez les instructions.',
    'Change currencies ISO Codes' => 'Changer les ISO codes devises',
    'Are you sure you want to logout ?' => 'Vous êtes certain de vouloir vous déconnecter ?',
    'The password is missing.' => 'Le mot de passe est manquant.',
    'You can manage the currencies of your PayPal account. Ideally, make them match with the available currencies of your store.' => 'Vous pouvez gérer les devises de votre Compte PayPal. Idéallement, faites les coïncider avec les devises disponibles de votre boutique.',
    'You can process a limited amount in card transactions.' => 'Vous ne pouvez recevoir qu\'un montant limité en paiements par carte.',
    'Activate payment methods' => 'Activer les moyens de paiement',
    'We sent you an email with instructions to reset your password. Please check your inbox.' => 'Nous vous avons envoyé un courrier électronique avec les instructions pour réinitialiser votre mot de passe. Veuillez vérifier votre boîte de réception.',
    'Unfortunately, you have revoked PrestaShop Checkout permissions. Credit card payments cannot be processed for you. You can still receive payments via PayPal. Please, log out your PayPal account just below and link your account giving permission again. You can contact PayPal help center to have more information about your account.' => 'Malheureusement, vous avez révoqué les permissions de PrestaShop Checkout. Le paiement par carte de crédit est indisponible pour le moment. Vous pouvez recevoir des paiements via PayPal. Veuillez deconnecter votre compte PayPal et le lier de nouveau pour donner les permissions une nouvelle fois. vous pouvez contacter le service client PayPal pour avoir plus de détails sur votre compte PayPal.',
    'No faq available. Try later.' => 'Pas de FAQ disponible. Veuillez essayer plus tard',
    'Design smart payment buttons' => 'Personnaliser les boutons de paiement intelligents',
    'You can choose the short or long description that appears on your customer\'s bank statements. Let\'s make them sure to understand their transaction!' => 'Vous pouvez choisir la description courte ou longue qui apparaît sur les relevés bancaires de vos clients. Faites en sorte qu\'il comprenne leur ligne de dépense.',
    'Email validation needed' => 'Validation de mail nécessaire',
    'No redirection when paying by credit card' => 'Aucune redirection lors du paiement par carte de crédit',
    'We cannot process credit card payments for you at the moment.' => 'Nous ne pouvons pas accepter les paiements par carte pour vous pour le moment.',
    'All custom themes might not be fully compatible. To avoid potential integration issues on payment page,' => 'Tous les thèmes personnalisés peuvent ne pas être entièrement compatibles. Pour éviter tout problème d\'intégration sur la page de paiement,',
    'We have received the confirmation from PayPal. You can now process all card transactions with no limits.' => 'Nous avons reçu la confirmation de PayPal. Vous pouvez maintenant accepter tous les paiements par cartes sans aucune limite.',
    'The email is not found.' => 'L\'email n\'a pas été trouvé.',
    'Payment preferences' => 'Préférences Paiement',
    'Sign in' => 'Se connecter',
    'Manage bank account' => 'Gérer votre compte en banque',
    'Log in or sign up to PayPal' => 'Connectez ou créez un compte PayPal',
    'Go to PayPal' => 'Aller sur PayPal',
    'Pending approval' => 'Approbation requise',
    'Couldn\'t find any answer to your question?' => 'Vous n\'avez pas trouvé de réponse à vos questions ? ',
    'Disabled' => 'Désactivé',
    'I accept the terms of use' => 'J\'accepte les conditions générales',
    'Limited to $500' => 'Limité à 500$',
    'Within your PayPal account, you can add a bank account to be beneficiary of your money transfer.' => 'Dans votre compte PayPal, ajoutez votre compte bancaire comme bénéficiaire pour transférer votre argent.',
    'Choose label' => 'Choisir le texte',
    'Approval pending' => 'Validation en attente',
    'Direct Sale' => 'Vente direct',
    'in the meantime, you will only accept credit cards payments thought the PayPal branded credit card fields' => 'Entre temps, vous ne pouvez accepter les paiements par cartes uniquement grâce aux champs de carte bancaires générés par PayPal.',
    'Category page' => 'Page catégorie',
    'See the full list of transactions on your PayPal account' => 'Voir toutes les transactions sur votre compte PayPal.',
    'Select the shape' => 'Choisir la forme',
    'Log in' => 'Se connecter',
    'PayPal branded Credit Card Fields' => 'Champs de Carte Alternatifs de Paypal',
    'Town' => 'Ville',
    'Buy Now' => 'Acheter',
    'All countries' => 'Tous les pays',
    'Learn more about managing your data and rights.' => 'Pour en savoir plus, consultez notre Politique de protection des données. ',
    'Pay in 4x, save credit cards, authorize mode, send payments direct link... and more to come! Let us know what you would love to be added to this module: any new feature or behavior improvement!' => 'Paiement en 4 fois, enregistrer les cartes de crédit, mode autorisation, envoyer des liens de paiement direct… et encore plus à venir ! Faites-nous savoir ce que vous adoreriez voir apparaître dans le module : n\'importe quelle fonctionnalité ou amélioration de comportement ! ',
    'Authentication' => 'Authentification',
    'A freelancer' => 'Un freelance',
    'Go to the dispute management platform' => 'Aller à la plateforme de gestion des litiges',
    'Send my legal documents now' => 'Envoyer mes documents légaux maintenant.',
    'Save' => 'Enregistrer',
    'Send your legal documents to PayPal : ' => 'Envoyer vos documents légaux à PayPal',
    'Payer action required' => 'Action requise',
    '10 payment methods included all-in-one' => '10 moyens de paiement inclus tout-en-un',
    'Customer' => 'Client',
    'Email' => 'Email',
    'Rectangle' => 'Rectangle',
    'Unfortunately, credit card payments cannot be processed for you at the moment. You will be able to reapply after 90 days. In the meantime, you can still receive payments via PayPal' => 'Malheureusement, les cartes de crédit ne peuvent pas être acceptées pour le moment. Vous pourrez postuler à nouveau dans 90 jours. Entre temps, vous pouvez accepter les paiements par PayPal.',
    'Let\'s choose the conversion rules for any transaction in a currency other than those activated on your account, should they be automatically converted or request your validation.' => 'Choisissez les règles de conversions pour les transactions dans une monnaie autre que celles configurées sur votre compte, pour qu\'elles soient automatiquement converties ou qu\'elles nécessitent une approbation de votre part.',
    'Select background color' => 'Choisir une couleur de fond',
    'Partially completed' => 'Paiement partiel',
    'pending transaction(s)' => 'transaction(s) en attente',
    'Local payment buttons' => 'Méthodes de paiement locales',
    'Business category' => 'Catégorie de l\'entreprise',
    'Thank you, close this message' => 'Merci, fermer ce message.',
    'Are you' => 'Vous êtes',
    'Sign up' => 'Créer un compte',
    'Pay with' => 'Payer avec',
    'Business subcategory' => 'Sous-catégorie de l\'entreprise',
    'https://www.prestashop.com/en/prestashop-checkout' => 'https://www.prestashop.com/fr/prestashop-checkout',
    'Password' => 'Mot de passe',
    'Address' => 'Adresse',
    'Currencies' => 'Devises',
    'Choose page location for banners' => 'Choisissez l\'emplacement des bannières sur la page',
    'Warning : the currencies you have activated : {0} are not currently supported by PrestaShop Checkout. Please deactivate {0} for PrestaShop Checkout in your' => 'Attention : les monnaies que vous avez activées :{0} ne sont pas actuellement supportées par PrestaShop Checkout. Veuillez désactiver {0} pour PrestaShop Checkout dans vos',
    'Need help? Find here the documentation of this module' => 'Besoin d\'aide ? Trouvez ici la documentation du module',
    'account' => '  ',
    'For more informations about your fees please visit this page:' => 'Pour plus d\'informations sur les frais, visitez la page : ',
    'Synchronization between your store and your PayPal account is in progress. Please wait.' => 'La synchronisation entre votre boutique et votre compte PayPal en cours. Veuillez patienter.',
    'Match currencies' => 'Ajuster les devises',
    'Store name' => 'Nom du magasin',
    'Credit card' => 'Carte de crédit',
    'As for local payment methods, buttons will be displayed according to the purchase context: country, amount, device, etc.' => 'Pour les méthodes de paiement locales, les boutons seront affichées dans certains contextes : pays, montant, appareil, …',
    'Black' => 'Noir',
    'Shipping' => 'Livraison',
    'Product page' => 'Page Produit',
    'Optional' => 'Optionnel',
    'Go back to login' => 'Retourner vers la connexion',
    'Restricted' => 'Limité',
    'Revoked' => 'Revoqué',
    'Know more' => 'En savoir plus',
    'Order summary page' => 'Page de résumé de panier',
    'Payment method' => 'Moyens de paiement',
    'A merchant' => 'Un marchand',
    'Manage your account' => 'Gérer votre compte',
    'Switch to test mode?' => 'Activer le mode test ?',
    'Onboarding almost done!' => 'Intégration presque terminée !',
    'By submitting this form, I agree that the data provided may be collected by PrestaShop S.A to permit (i) the use of our services (ii) to improve your customer experience. Your data can be transmitted to our partner Paypal if you do not already have an account.' => 'En soumettant ce formulaire, vous acceptez que votre adresse mail soit utilisée par PrestaShop S.A pour créer un compte Checkout. En créant votre compte, vous recevrez de la prospection commerciale de la part de PrestaShop',
    'transaction(s)' => 'transaction(s)',
    'Payment methods activation' => 'Activation des moyens de paiement',
    'Capture at shipping' => 'Prélever à l\'expédition',
    'Account Linking in progress' => 'Liaison de boutique en cours',
    'Link your PayPal account' => 'Lier votre compte PayPal',
    'Silver' => 'Argent',
    'Availability' => 'Disponibilité',
    'Advanced settings' => 'Options avancées',
    'When to use PayPal branded Credit Card fields ?' => 'Quand faut-il utiliser les Champs de Carte Alternatifs de PayPal ?',
    'You have exceeded the maximum number of payment attempts.' => 'Vous avez atteint le nombre maximal de tentatives de paiement.',
    'The selected payment method does not support this type of transaction. Please choose another payment method or contact support for assistance.' => 'La méthode de paiement sélectionnée ne prend pas en charge ce type de paiement, veuillez sélectionner une autre méthode.',
    'This payment method seems not working currently, please try another.' => 'Cette méthode de paiement semble indisponible, veuillez utiliser un autre moyen de paiement',
    'This payment method declined transaction, please try another.' => 'Le moyen de paiement a refusé la transaction, veuillez en utilisant un autre.',
    'Your PayPal account is locked or closed, please try another.' => 'Votre compte PayPal est verrouillé ou fermé, veuillez en utiliser un autre.',
    'The transaction was blocked by Fraud Protection settings.' => 'La transaction a été bloquée par le service de protection contre la fraude.',
    'Your card cannot be used to pay in our country, please try another payment method.' => 'Votre carte ne peut pas être utilisée pour payer dans ce pays, veuillez essayer un autre moyen de paiement.',
    'You are not allowed to pay with this PayPal account, please try another.' => 'Vous n\'êtes pas autorisé à payer avec ce compte PayPal, veuillez en utiliser un autre.',
    'Card payment cannot be processed at the moment, please use another payment method.' => 'Le paiement par carte est actuellement indisponible, veuillez choisir une autre méthode de paiement.',
    'You are not allowed to pay with this payment method, please try another.' => 'Vous n\'êtes pas autorisé à payer avec ce moyen de paiement, veuillez en utiliser un autre.',
    'Make this card favorite / default ' => 'Définir comme méthode de paiement préférée',
    'Securely store payment details for future purchases' => 'Sauvegardez en toute sécurité vos informations de paiement',
    'Make this account favorite / default ' => 'Définir ce compte comme méthode de paiement préférée',
    'Make this my preferred payment method' => 'Définir comme méthode de paiement préférée',
    'This payment method has been saved to your account.' => 'Cette méthode de paiement a été enregistrée sur votre compte.',
    'This payment method has been saved to your account and defined as favorite for future purchases.' => 'Cette méthode de paiement est enregistrée sur votre compte et définie comme méthode de paiement préférée pour vos futurs achats.',
    'Delete' => 'Supprimer',
  ),
